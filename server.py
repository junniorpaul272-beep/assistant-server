...
# Overridable so you can drop to a cheaper/higher-free-tier model without a
# code change. gemini-2.5-flash is the default: solid function-calling
# support and the most generous free tier as of writing. If you're hitting
# free-tier rate limits, gemini-2.5-flash-lite is the cheaper fallback.
